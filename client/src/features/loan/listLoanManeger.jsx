    ...
    return (
        <div className="card">
            ...
            <DataTable value={allLoans} paginator rows={10} dataKey="_id" filters={filters} filterDisplay="row" loading={isLoading}
                globalFilterFields={['user.identity']} header={header} emptyMessage="No customers found.">
                <Column field="createdAt" header="createdAt" bodyClassName="text-center" filter filterPlaceholder="Search by identity" style={{ minWidth: '8rem', maxWidth: '10rem' }} />
                <Column field="updatedAt" header="updatedAt" bodyClassName="text-center" filter filterPlaceholder="Search by identity" style={{ minWidth: '8rem', maxWidth: '10rem' }} />
                <Column field="user.identity" header="Identity" bodyClassName="text-center" filter filterPlaceholder="Search by identity" style={{ minWidth: '8rem', maxWidth: '10rem' }} />
                <Column field="user.name" header="Name" bodyClassName="text-center" filter filterPlaceholder="Search by identity" style={{ minWidth: '8rem', maxWidth: '10rem' }} />
                <Column field="user.email" header="Email" bodyClassName="text-center" filter filterPlaceholder="Search by identity" style={{ minWidth: '8rem', maxWidth: '10rem' }} />
                <Column field="user.phone" header="Phone" bodyClassName="text-center" filter filterPlaceholder="Search by identity" style={{ minWidth: '8rem', maxWidth: '10rem' }} />
                <Column field="request.count" header="Count" bodyClassName="text-center" filter filterPlaceholder="Search by identity" style={{ minWidth: '8rem', maxWidth: '10rem' }} />
