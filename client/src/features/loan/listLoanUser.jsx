    ...
    const actionButtons = (rowData) => {
        return (<>
            {!rowData.take ? <div >
                ...
                <div >
                    <input icon='pi pi-upload' type="file" name="Img" onChange={(e) => handleFileChange(e, rowData._id)} />
                </div>
            }
        </>)
    }
    ...
    return (
        <div className="card">
            ...
            <DataTable value={allLoans} paginator rows={10} dataKey="_id" filters={filters} filterDisplay="row" loading={loading}
                ...
                <Column field="request.count" header="Count" body={CountBodyTemplate} bodyClassName="text-center" filter filterPlaceholder="Search by identity" style={{ minWidth: '8rem', maxWidth: '10rem' }} />
